...
const reviews: Review[] = [
    { id: 1, user: 'Alice', wine: 'Chardonnay', rating: 4, comment: 'Crisp and refreshing!' },
    { id: 2, user: 'Bob', wine: 'Merlot', rating: 5, comment: 'Rich and full-bodied.' },
    { id: 3, user: 'Charlie', wine: 'Pinot Noir', rating: 3, comment: 'Light and fruity.' },
];
